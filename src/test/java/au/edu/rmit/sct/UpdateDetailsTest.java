...
public class UpdateDetailsTest {
    ...
    public void testAdultCanChangeAddress() {
        ...
        assertTrue(p2.updatePersonalDetails("5xy%z#78AA", "Jane", "Smith", "88|New Rd|Melbourne|Victoria|Australia", "01-01-2000"));
    }
    @Test
    ...
    public void testEvenStartingIDCannotBeChanged2() {
        ...
        assertFalse(p9.updatePersonalDetails("5mn*W@96LB","Liam","Chen","99|Station Rd|Werribee|Victoria|Australia","04-04-1990"));
    }    
